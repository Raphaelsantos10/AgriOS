...
import { CalendarDays, CheckCircle2, CircleDollarSign, Clock3, Plus, Search, SlidersHorizontal, Wrench } from "lucide-react";
import Button from "../../../design-system/components/Button";
import Card from "../../../design-system/components/Card";
import CreateWorkOrderModal from "../components/CreateWorkOrderModal";
import { PriorityLabel, StatusBadge } from "../components/WorkOrderBadge";
import { createWorkOrder, listWorkOrders, updateWorkOrderStatus } from "../services/workOrderStorage";
  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-6">
      <header className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        ...
        <Button onClick={() => setModalOpen(true)}><Plus size={18} /> Nova ordem</Button>
      </header>
