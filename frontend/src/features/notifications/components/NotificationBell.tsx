...
export default function NotificationBell() {
  ...
  return <div ref={panelRef} className="relative">
    ...
    {open && <section role="dialog" aria-label="Notificações agrícolas" className="absolute right-0 top-12 z-[1000] w-[min(94vw,430px)] overflow-hidden rounded-2xl border border-[var(--farpha-border)] bg-[var(--farpha-surface)] shadow-2xl">
