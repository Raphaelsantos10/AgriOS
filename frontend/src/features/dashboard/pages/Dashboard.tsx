    ...
    <section className="-m-4 min-h-full space-y-4 bg-[radial-gradient(circle_at_top_right,rgba(156,223,40,0.08),transparent_26%),#061014] p-4 text-white md:-m-6 md:p-6 xl:-m-7 xl:p-7">
      <header className="flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-black tracking-tight text-white">Bom dia, Raphael! 👋</h1>
          <p className="mt-1 text-sm text-[#9aa9a2]">Aqui está o resumo inteligente da sua operação agrícola.</p>
        </div>
      ...
      <div className="grid min-h-[620px] gap-4 2xl:grid-cols-[minmax(0,1fr)_350px]">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0b171a] shadow-[0_26px_80px_rgba(0,0,0,0.30)]">
          ...
          <div className="h-[620px] min-h-[620px] [&_.leaflet-control]:opacity-90">
            <MapView farms={farms} />
          </div>
